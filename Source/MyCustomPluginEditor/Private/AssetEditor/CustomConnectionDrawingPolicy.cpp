...
{
	// Draw a line/spline
	FConnectionDrawingPolicy::DrawConnection(WireLayerID, Start, End, Params);
}

void FCustomConnectionDrawingPolicy::DetermineWiringStyle(UEdGraphPin* OutputPin, UEdGraphPin* InputPin, /*inout*/ FConnectionParams& Params)
{
